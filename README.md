...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://anastasiia-zuieva.github.io/react_tabs-with-router/) and add it to the PR description.
